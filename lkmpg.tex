...
To allow arguments to be passed to your module, declare the variables that will take the values of the command line arguments as global and then use the \cpp|module_param()| macro, (defined in \verb|linux/moduleparam.h|) to set the mechanism up.
...
So to help people writting /proc file, there is an API named \cpp|seq_file| that helps formating a /proc file for output.
